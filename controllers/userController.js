...
const updateProfile = async(req, res) =>{
    ...
    try {
            ...
            if(req.file){
                const userData = await User.findByIdAndUpdate({_id: req.body.user_id}, {$set: {name: req.body.name, email: req.body.email, phone: req.body.mno, image:req.file.filename}})
            }else{
